...
//    }
    ...
    fun testInternetSettings() {
        ...
        device.findObject(
            UiSelector().resourceId("android:id/title").instance(0)).click()
    }
    ...
    fun testEmptyTextDoesNotChangeTextView() {
        ...
        // Set empty text (including whitespace)
    ...
    @Test
    fun testNewActivityUpdatesTextView() {
        val packageName = MODEL_PACKAGE
        waitForPackage(packageName)
        ...
        // Ensure the text matches the input text
        assertEquals(result, textToSet)
    }
}